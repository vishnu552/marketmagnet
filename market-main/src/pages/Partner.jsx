      ...
      <div className="wrapper12 mx-auto py-40">
        ...
        <div className="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-12 bg-no-repeat bg-cover bg-center bg-father">
            ...
            <h1 className="text-[#3a41bd] text-bold text-5xl mb-3">Welcome</h1>
            <div>
              <p className="text-bold text-white text-2xl">"We invite forward-thinking investors to join us on a journey of innovation and growth. By becoming our partner, you align yourself with a vision for success, where opportunities are explored, challenges are met with resilience, and together, we shape the future of HubAlt. Let's embark on this exciting venture together and redefine what's possible."</p>
            </div>
          </div>
          <div className="w-full lg:w-1/2 py-16 px-12">
            <h2 className="text-6xl text-bold text-center text-[#3a41bd] mb-4">Register</h2>
            <p className="mb-4 text-bold text-center">
            ...
            <form action="#">
              ...
              <div className="mt-5">
                <button className="w-full bg-[#3a41bd] py-3 text-center text-white">Register Now</button>
              </div>
            </form>
          </div>
        </div>
